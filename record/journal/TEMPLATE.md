...
- **Gravity check:** (Night only. Do the last three entries sound like the same session? If today felt like a loop, name it. Tomorrow, push in a different direction.)
```
